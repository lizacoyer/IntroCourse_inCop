...
Have a look at the relative risk for being a case having eaten a specific food item (for example, moussake), when stratified by another variable (for example, orzo). You may consider stratifying by orzo, as it has the highest
RR in the univariable analysis.
...
### c) Champagne as exposure of interest, stratified by having eaten orzo
