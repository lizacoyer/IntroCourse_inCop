...
-   `SimOb_RInject10.qmd`: Inject number 10, focused on Data import and cleaning.
-   `SimOb_RInject11.qmd`: Inject number 11, focused on "person, place and time" and case definition.
-   `SimOb_RInject12.qmd`: Inject number 12, focused on Laboratory data and descriptive analysis.
-   `SimOb_RInject15.qmd`: Inject number 15, focused on Univariate analysis.
-   `SimOb_RInject16.qmd`: Inject number 16, focused on Stratified analysis.
